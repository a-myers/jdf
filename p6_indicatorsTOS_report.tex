...
\subsection{Charts}
\begin{jdffigure}
\includegraphics[height=6cm]{Figures/Figure6.png}%{\huge Handgloves}%
...
\begin{tabular}{@{} L{0.15\linewidth} c S L{0.52\linewidth}}
    \textbf{Strategy} & \textbf{Cum. Returns} & \textbf{Daily Returns Mean} & \textbf{Daily Returns Std. Dev.} \\
    \toprule[0.5pt]
    Benchmark & \$-8340.00 & 4.974874 & 805.851630\\
    \midrule
    Optimal & \$312020.00 & 618.894472 &  515.195577\\
    \midrule
\end{tabular}
\end{jdftable}

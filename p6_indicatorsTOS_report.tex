...
To calcualte the PPO, we first need to choose two periods, one long and one short. We can then calculate the SMA of the asset's price over each of these periods using the SMA indicator from 1.1.
...
We also assue commsision and impact are 0.

...
\begin{jdftable}
\captionof{table}{Performance of Manual Strategy comapred to Benchmark for in-sample and out-of-sample periods.}\label{table:Example}
\small % Reduce font size
\begin{tabular}{@{} L{0.15\linewidth} c S L{0.52\linewidth}}
	\textbf{Portfolio} & \textbf{Cumulative Returns} & \textbf{Std. Dev. of Daily Returns} & \textbf{Mean of Daily Returns} \\
	\toprule[0.5pt]
	Benchmark In-Sample & 0.012 & 1604.88 & 2.44\\
	\midrule
	Benchmark Out-of-Sample & -0.084 & 809.294 & -16.581\\
	\midrule
	Manual In-Sample & 0.093 & 1167.342 & 18.395\\
	\midrule
	Manual Out-of-Sample & 0.052 & 480.543 & 10.325\\
\end{tabular}
\end{jdftable}
...
% \small % Reduce font size
% \begin{tabular}{@{} L{0.15\linewidth} c S L{0.52\linewidth}}
% 	\textbf{Stat} & \textbf{Benchmark In-Sample} & \textbf{Benchmark Out-of-Sample} & \textbf{Manual In-Sample} & \textbf{Manual Out-of-Sample} \\
% 	\toprule[0.5pt]
% 	Cumulative Returns & 1.23 & 4.56 & 7.89 & asdf\\
% 	\midrule
% 	Std. Dev. of Daily Returns & 1.23 & 4.56 & 7.89 & asdf\\
% \end{tabular}
% \end{jdftable}

Looking at these results, it may be easy to assume that the Manual Strategy is a good strategy, as the out-of-sample results outperformed even the in-sample-results (in relation to the benchmark).
...
\begin{jdftable}
\captionof{table}{Strategy Learner Final Trade Count and Sharpe Ratio for Different Impact Values.}\label{table:Example}
\small % Reduce font size
\begin{tabular}{@{} L{0.15\linewidth} c S L{0.52\linewidth}}
	\textbf{Stat} & \textbf{Impact 0.001} & \textbf{Impact 0.005} & \textbf{Impact 0.01} \\
	\toprule[0.5pt]
	Trade Count & 181 & 175 & 159\\
	\midrule
	Sharpe Ratio & 2.203 & 1.234 & 1.057\\
\end{tabular}
\end{jdftable}

As we can see in \textbf{Table 2}, our hypotheses were correct.

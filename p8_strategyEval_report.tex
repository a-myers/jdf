...
\title{CS 7646: Project 8 - Putting it All Together}
...
\captionof{figure}{Manual Strategy vs Benchmark Strategy during in-sample period of 2008-209. Both portfolio values are normalized to 1. Blue vertical lines indicate LONG entrypoints, and Black lines indicate SHORT entrypoints.}\label{fig:figure1}%
\end{jdffigure}
...
\captionof{figure}{Manual Strategy vs Benchmark Strategy during out-of-sample period of 2010-2011. Both portfolio values are normalized to 1. Blue vertical lines indicate LONG entrypoints, and Black lines indicate SHORT entrypoints.}\label{fig:figure1}%
\end{jdffigure}
...
example: \citeinl{joyner2016} claim that a round of peer review prior to grading may improve graders’ efficiency and the quality of feedback given. This applies to parenthetical 
